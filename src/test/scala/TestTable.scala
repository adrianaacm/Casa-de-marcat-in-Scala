...
class TestTable extends AnyFunSpec with BeforeAndAfterAll {
  ...
  override def afterAll(): Unit = {
    println(s"Punctaj Table + Filter: ${SharedTestData.tableScore}p/50p")
    //50p
  }
  ...
  describe("apply") {
    it("Test apply (5p)") {
      ...
      SharedTestData.addPointsTable(5)
    }
  }
  ...
  describe("toString") {
    it("Test toString (2p)") {
      ...
      SharedTestData.addPointsTable(2)
    }
  }
  ...
  describe("Test operations") {
    it("Insert (3p)") {
      ...
      SharedTestData.addPointsTable(3)
    }
    ...
    it("Filter (15p)") {
      ...
      SharedTestData.addPointsTable(15)
    }
    ...
    it("Update (10p)") {
      ...
      SharedTestData.addPointsTable(10)
    }
  }
}
